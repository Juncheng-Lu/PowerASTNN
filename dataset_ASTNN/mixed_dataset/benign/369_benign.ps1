...
(
 ...
 -||-> $ManagedAppPolicy <-||- 
    ...
    if( -||-> $ManagedAppPolicy.'@odata.type' -eq "
        ...
        $AndroidManagedAppProtection = Get-ManagedAppProtection -id $ManagedAppPolicy.id -OS " -||-> A <-||- Android"
    ...
    elseif -||-> ( -||-> $ManagedAppPolicy.'@odata.type' -eq "
        ...
        $Win10ManagedAppProtection = Get-ManagedAppProtection -id $ManagedAppPolicy.id -OS " -||-> W <-||-  <-||- WIP_WE"
