...
BEGIN
{
    TRY
    {
        ...
        " -||-> T <-||- TD{ -||-> border-width: 1px <-||- ; -||-> padding-right: 2px <-||- ; -||-> padding-left: 2px <-||- ; -||-> padding-top: 0px <-||- ; -||-> padding-bottom: 0px <-||- ; -||-> border-style: solid <-||- ; -||-> border-color: black <-||- ; -||-> background-color:white <-||- }" +
        "</style>"
        $Head2 = "<style>" +
