...
function Disable-SecuritySettings {
    ...
    if(!(Test-Path $LMSecurityKey)){
        ...
        $cmd += " -||-> N <-||- New-ItemProperty $LMSecurityKey -Name ObjectModelGuard -Value 2 -PropertyType DWORD -Force <-||- ;  -||-> "
        ...
        if($currentValue -and ($currentValue -ne 2)){
            ...
            $cmd = " -||-> S <-||- Set-ItemProperty $LMSecurityKey -Name ObjectModelGuard -Value 2 -Force <-||- ;  -||-> "
        }
        elseif(!($currentValue)) {
            $cmd = " -||-> N <-||- New-ItemProperty $LMSecurityKey -Name ObjectModelGuard -Value 2 -PropertyType DWORD -Force <-||- ;  -||-> "
        }
    ...
    if(!(Test-Path $CUSecurityKey)){
        ...
        $cmd += " -||-> N <-||- New-Item $CUSecurityKey -Force <-||- ;  -||-> "
        $cmd += " -||-> N <-||- New-ItemProperty $CUSecurityKey -Name PromptOOMSend -Value 2 -PropertyType DWORD -Force <-||- ;  -||-> " 
        $cmd += " -||-> N <-||- New-ItemProperty $CUSecurityKey -Name AdminSecurityMode -Value 3 -PropertyType DWORD -Force <-||- ;  -||-> "
        ...
        if($currentValue -and ($currentValue -ne 2)){
            ...
            $cmd += " -||-> S <-||- Set-ItemProperty $CUSecurityKey -Name PromptOOMSend -Value 2 -Force <-||- ;  -||-> "
        ...
        if($currentValue -and ($currentValue -ne 3)){
            ...
            $cmd += " -||-> S <-||- Set-ItemProperty $CUSecurityKey -Name AdminSecurityMode -Value 3 -Force"
...
function Reset-SecuritySettings {
    ...
    if(Test-Path $CUSecurityKey){
        ...
        $cmd += " -||-> R <-||- Remove-ItemProperty -Path $CUSecurityKey -Name PromptOOMSend -Force <-||- ; -||-> " 
        $cmd += " -||-> R <-||- Remove-ItemProperty -Path $CUSecurityKey -Name AdminSecurityMode -Force"
