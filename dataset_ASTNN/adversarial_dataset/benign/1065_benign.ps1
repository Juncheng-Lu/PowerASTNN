...
"@ <-||- 
                 ...
                 -||-> $TestCases = @(
                    ...
                    @{ element =  <-||- ' -||-> H <-||- Header2'; InputMD = ' <-||- 
                     -||-> @{ element =  -||-> 'Header3' <-||- ; InputMD =  -||-> '
                    @{ element =  <-||- ' -||-> H <-||- Header4'; InputMD = ' <-||- 
                     -||-> @{ element =  -||-> 'Header5' <-||- ; InputMD =  -||-> '
                    @{ element =  <-||- ' -||-> H <-||- Header6'; InputMD = ' <-||- 
...
'@ <-||- 
             ...
             -||-> $testCases = @(
                ...
                @{Type =  <-||- " -||-> H <-||- Header2"; Markdown = " <-||- 
                 -||-> @{Type =  -||-> "Header3" <-||- ; Markdown =  -||-> "
                @{Type =  <-||- " -||-> H <-||- Header4"; Markdown = " <-||- 
                 -||-> @{Type =  -||-> "Header5" <-||- ; Markdown =  -||-> "
                @{Type =  <-||- " -||-> H <-||- Header6"; Markdown = " <-||- 
     ...
     -||-> Context "Show-Markdown tests" {
         ...
         -||-> It "Markdown files work with cmdlet: <pathParam>" -TestCases @(
            ...
            $mdFile = Join-Path $TestDrive " -||-> t <-||- test.md"
        ...
        It " -||-> G <-||- Gets an error if the input object is missing the <propertyname> property." -TestCases @(
            @{ propertyname = 'Html' }
